...
use ackplane_protocol::v1::{
    node_frame, ClaimAuthentication, ClaimLeaseOutcome, ClaimLeaseRequest, ClaimLeaseResult,
    ClaimRecoverRequest, ClaimReleaseRequest, ClaimReleaseResult, ClaimRenewRequest,
    EnrollmentActivationProof, EnrollmentChallenge, EnrollmentChallengeRequest, EnrollmentRequest,
    EnrollmentState, EventEnvelope, Hello, KeyRotationOutcome, KeyRotationRejectionReason,
    KeyRotationRequest, KeyRotationResult, NodeFrame, Notice, ProvenanceClass,
};
use prost::Message;
