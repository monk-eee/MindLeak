//! Durable local directive inbox for one enrolled supervisor session.
//!
...
impl StoredReceipt {
    fn into_receipt(self) -> v1::DirectiveReceipt {
        v1::DirectiveReceipt {
...
fn next_sequence(transaction: &Transaction<'_>) -> Result<i64, rusqlite::Error> {
