        ...
        json!({
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "branch_committed_paths": { "type": "array", "items": { "type": "string" }, "description": "claim: paths committed on this branch since its base. Reports uncovered clauses in `branch_inherited`, not `governing` (ADR-0147). Advisory; omit/[] for today's response." },
