- **Symbol and import extraction remains heuristic and partially scoped.** —
  ...
  re-exports, path aliases, computed or template-literal dynamic imports, and
  other language import syntaxes are not resolved. Type hierarchy supports
  simple named local and imported JS/TS heritage, not default/namespace targets
  or expression-based mixins. Non-JS brace/indent extractors also remain
