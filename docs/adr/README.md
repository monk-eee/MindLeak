...
| [0126](0126-the-bridge-proposes-constitution-amendments-only-a.md) | The Bridge proposes constitution amendments; only a repository activates them | Proposed |
| [0127](0127-agent-issued-shell-commands-are-auditable-evidence.md) | Agent-issued shell commands are auditable evidence, not just prose discipline | Proposed |
