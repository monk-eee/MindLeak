...
| [0146](0146-a-supervisor-declares-its-own-frame-sequence.md) | A supervisor declares its own frame sequence; the server only echoes what it accepted | Proposed |
